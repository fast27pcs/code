...
if [ $1 == 1 ]; then
    ...
    ssh root@192.168.0.249 '/home/defend/wondershaper/wondershaper/wondershaper -c -a eth0; /home/defend/wondershaper/wondershaper/wondershaper -a eth0 -d 2500000 -u 2500000'
elif [ $1 == 6 ]; then
    ssh root@192.168.0.249 '/home/defend/wondershaper/wondershaper/wondershaper -c -a eth0;echo done'
else
    echo "cluster_number:"${#ARRAY[@]}
    for i in $(seq 0 $NUM)
    do
